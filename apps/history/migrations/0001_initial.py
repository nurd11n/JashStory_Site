# Generated by Django 4.2.5 on 2024-03-02 16:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_en', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='history.collection')),
                ('collection_ky', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='history.collection')),
                ('collection_ru', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='history.collection')),
